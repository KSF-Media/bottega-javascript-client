...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the paymentMethodCreditCardPost operation.
     * @callback module:api/PaymentMethodsApi~paymentMethodCreditCardPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreditCard} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.authUser 
     * @param {String} opts.authorization 
     * @param {module:api/PaymentMethodsApi~paymentMethodCreditCardPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreditCard}
     */
    this.paymentMethodCreditCardPost = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
