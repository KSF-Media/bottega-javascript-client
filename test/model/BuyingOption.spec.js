...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bottega.BuyingOption();
  });
  ...
  describe('BuyingOption', function() {
    it('should create an instance of BuyingOption', function() {
      // uncomment below and update the code to test BuyingOption
      //var instane = new Bottega.BuyingOption();
